      ...
      {aopObjectives.length === 0 ? (
        ...
        >
          ...
          >
            ...
            <img src={no_result} alt="not-found-img" width={140} />
            ...
            <Typography mt={2} sx={{ fontSize: 14 }}>
              Nothing to show yet for this year’s AOP. You may request new items
              for the
              <b> meantime or create a new AOP request.</b>
            </Typography>
          </Stack>
            ...
            <Stack>
              ...
              >
                ...
                <Typography sx={{ color: "white", fontSize: 14 }}>
                  ...
                  body. This could be as short as a<br></br>
                  single sentence but could be as long as two sentences if
                  necessary.
                </Typography>
              </Box>
            </Stack>
                        ...
                        <BoxComponent p={2}>
                          ...
                          >
                            ...
                            <Typography sx={{ fontSize: 14, fontWeight: 400 }}>
                              Contains(14) success indicators in total on this
                              request
                            </Typography>
                          </Stack>
                        </BoxComponent>
                      ...
                      <Grid item={"true"} sm={5} md={5.8}>
                        <BoxComponent p={2}>
                          ...
                          >
                            {/* <MousePointerClick size={20} /> */}
                            <Typography sx={{ fontSize: 14, fontWeight: 400 }}>
                              Where (6) are GAD-related and (6) are not
                              GAD-related on this reques
                            </Typography>
                          </Stack>
                        </BoxComponent>
                      </Grid>
                      ...
                      <Grid item={"true"} sm={5} md={5.8}>
                        <BoxComponent p={2}>
                          ...
                          >
                            {/* <MousePointerClick size={20} /> */}
                            <Typography sx={{ fontSize: 14, fontWeight: 400 }}>
                              Includes (6) job positions, (6) areas (2) persons
                              in total
                            </Typography>
                          </Stack>
                        </BoxComponent>
