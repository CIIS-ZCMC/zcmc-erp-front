...
export const useResourcesActions = () =>
  useResourcesHook((state) => state.actions);

export const useResources = () => useResourcesHook((state) => state.resources);

export const useActivityResource = () =>
  useResourcesHook((state) => state.activity);

export const usePaginationResource = () =>
  useResourcesHook((state) => state.pagination);
